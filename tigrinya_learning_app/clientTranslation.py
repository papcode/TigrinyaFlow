...
def latin_to_geez_letter(text: str) -> str:
    ...
    mapping = {
        'h': 'ሀ', 'ḥ': 'ሐ', 'k': 'ከ', 'ḫ': 'ኸ', 'x': 'ኀ', 'ʿ': 'ዐ', 
        'l': 'ለ', 'm': 'መ', 'r': 'ረ', 's': 'ሰ', 'š': 'ሸ', 'č': 'ቸ',
        't': 'ተ', 'ṭ': 'ጠ', 'b': 'በ', 'g': 'ገ', 'd': 'ደ', 'f': 'ፈ',
        'p': 'ፐ', 'n': 'ነ', 'z': 'ዘ', 'ž': 'ዠ', 'y': 'የ', 'w': 'ወ',
        'j': 'ጀ', 'q': 'ቀ', 'ñ': 'ኘ', 'ṣ': 'ፀ', 'č̣': 'ጨ', 'p̣': 'ጰ'
    }
...
def geez_to_latin_letter(text: str) -> str:
    ...
    reverse_map = {
        'ሀ': 'h', 'ሐ': 'ḥ', 'ከ': 'k', 'ኸ': 'ḫ', 'ኀ': 'x', 'ዐ': 'ʿ',
        'ለ': 'l', 'መ': 'm', 'ረ': 'r', 'ሰ': 's', 'ሸ': 'š', 'ቸ': 'č',
        'ተ': 't', 'ጠ': 'ṭ', 'በ': 'b', 'ገ': 'g', 'ደ': 'd', 'ፈ': 'f',
        'ፐ': 'p', 'ነ': 'n', 'ዘ': 'z', 'ዠ': 'ž', 'የ': 'y', 'ወ': 'w',
        'ጀ': 'j', 'ቀ': 'q', 'ኘ': 'ñ', 'ፀ': 'ṣ', 'ጨ': 'č̣', 'ጰ': 'p̣'
    }
